...
This repo is a work-in-progress. Currently, we have released the code for joint representation learning of images and text by maximizing the mutual information between the feature embeddings of the two modalities. It's demonstrated in the application of chest radiographs and radiology reports.
